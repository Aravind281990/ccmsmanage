...
public class CreditCardEnDecryption {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CreditCardEnDecryption.class);
    ...
    public String encrypt(String creditCardNumber) throws Exception {
        logger.info("Entering encryption method");
        try {
            // Print the AES key for debugging (Make sure it's not null)
            logger.info("AES Key: {}", constantKeyBase64);
    ...
    public String decrypt(String encryptedCreditCard) throws Exception {
        try {
            logger.info("Entering decryption method");
            // Print the AES key for debugging (Make sure it's not null)
            logger.info("AES Key: {}", constantKeyBase64);
            ...
            logger.error("Error during decryption", ex);
